    ...
    <div className="new-case">
      <div className="window-case">
        ...
        <form className="form-case" onSubmit={handleSubmit}>
          ...
          />
          <label htmlFor="type">
            Тип велосипеда<span style={{ color: "red" }}>*</span>
          </label>
          <select
            className="input"
            name="type"
        ...
        <p className={`thanks ${isVisible ? "visible" : "unvisible"}`}>
          Данные приняты. Спасибо за помощь!
        </p>
      </div>
    </div>
  );
