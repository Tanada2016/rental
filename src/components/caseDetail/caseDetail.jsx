...
const CaseDetail = () => {
  ...
  const caseLoaded = useSelector((state) =>
    state.cases.find((message) => message.id === caseId)
  );
  ...
  const curStatus = Object.keys(statuses).find(
    (key) => key === caseEdited.status
  );
    ...
    <div className="caseDetail">
      ...
      <form className="form-case" onSubmit={handleSubmit} id="form">
        ...
        <input
          ...
          required
          value={caseEdited.licenseNumber}
          disabled={isDisabled}
        />
        <label className="label" htmlFor="ownerFullName">
          ФИО
        </label>
        <input
          className="input"
          ...
          onChange={handleChange}
          required
          value={caseEdited.ownerFullName}
          disabled={isDisabled}
        />
        ...
        <textarea
          className={`input textarea ${
            caseEdited.description || !isDisabled ? "" : "empty"
          }`}
          name="description"
          id="description"
          type="text"
        ...
        <input
          ...
          name="createdAt"
          id="createdAt"
          value={caseEdited.createdAt}
          disabled
        />
        <label className="label" htmlFor="updatedAt">
